...
- 🧠 **打工人团队一键配置**：一行命令配置能独立完成各项任务的打工人团队。
- 👥 **多场景覆盖**：任意角色组队，覆盖多个场景：头脑风暴、社会模拟、全栈开发、数据分析等。
...
| 团队名 | 能力 | 部署命令(需要到[幻境工坊](https://www.itswarmbee.com)下载配置包) |
|--------|------|----------|
