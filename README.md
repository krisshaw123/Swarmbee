...
| 狼人杀 🐺 | 健身助手 💪 | 场馆预约 🏟️ |
|:---:|:---:|:---:|
| <video src="videos/werewolf-30s.mp4" width="300" controls muted loop></video> | <video src="videos/fitness-30s.mp4" width="300" controls muted loop></video> | <video src="videos/sports-booking-30s.mp4" width="300" controls muted loop></video> |

> 将 3 个 mp4 文件放入 `videos/` 目录并对应命名即可。如需替换为 GIF，将 `<video>` 标签改为 `<img>` 标签即可。
